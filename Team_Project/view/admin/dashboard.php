...
<script>
    ...
    // const fields = {
    //     catalog: ['Book Title', 'Author', 'Genre', 'Total Copies', 'Available Copies'],
    //     users: ['User ID', 'Book ID', 'Borrowed Date', 'Due Date', 'Return Date'],
    //     events: ['Event ID', 'Event Name', 'Location', 'Event Date', 'Description']
    // };
    ...
    function showSection(section) {
        ...
        fields[section].forEach(field => {
            ...
            input.id = `input-${field.toLowerCase().replace(/ /g, '-')}`;
    ...
    function addItem(section) {
        const newItem = {};
        fields[section].forEach(field => {
            const value = document.getElementById(`input-${field.toLowerCase().replace(/ /g, '-')}`).value;
            if (!value) {
                alert('Please fill in all fields.');
                return;
            }
            newItem[field.toLowerCase().replace(/ /g, '_')] = value;
        });
    ...
    function addTableRow(section, item, index) {
        ...
        fields[section].forEach(field => {
            ...
            td.textContent = item[field.toLowerCase().replace(/ /g, '_')];
            row.appendChild(td);
        });
