        ...
        <div class="card">
            ...
            <form action="../actions/books/add_book.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" required maxlength="255" value=<?php echo $book['title'] ?>>
                </div>
                <div class="form-group">
                    <label for="author">Author *</label>
                    <input type="text" id="author" name="author" required maxlength="100" value=<?php echo $book['author'] ?>>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="available_copies" name="available_copies" min="1">
                </div>
                <div class="form-group">
